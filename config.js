...
module.exports = {
    ...
    // Configuration pour LIKE STATUS
    likeStatus: {
        enabled: process.env.LIKE_STATUS_ENABLED || "true", // Mettre à false pour désactiver par défaut
        defaultEmoji: process.env.LIKE_STATUS_EMOJI || '👍', // Emoji par défaut pour liker les statuts
    },
};